...
/*************************************************************************************/
	...
	//rtsp://192.168.11.21/video?type=realtim&channnel=1&starttime=887&length=885
	...
	//if(strstr(streamName, "video?type="))
	{
		...
		//else
		{
			...
			sms->addSubsession(H264VideoServerMediaSubsession\
						::createNew(envir(), 0/*channel*/, reuseFirstSource));
			//音频
				sms->addSubsession(PCMAudioServerMediaSubsession::createNew(envir(),0));
